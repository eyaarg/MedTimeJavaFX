...
public class NotificationListControllerArij {
    ...
    private final NotificationServiceArij service = new NotificationServiceArij();
    ...
    private void loadNotifications() {
        ...
        List<NotificationArij> list = service.getMyNotifications();
        ...
        for (NotificationArij n : list) {
            notificationsContainer.getChildren().add(buildRow(n));
        }
    }

    private HBox buildRow(NotificationArij n) {
        ...
        dot.setStyle("-fx-background-color:" + (n.isRead() ? "#cbd5e1" : "#2563eb")
        ...
        title.setStyle("-fx-font-size:13px;-fx-font-weight:" + (n.isRead() ? "normal" : "bold")
                + ";-fx-text-fill:#0f172a;");
    ...
    private VBox emptyState() {
        ...
        Label sub = new Label("Aucune nouvelle notification pour le moment");
